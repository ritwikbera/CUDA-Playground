...
int main(void)
{
    ...
    cout << "Enter m n n k :" << endl;

    cin >> Left_matrix_x >> Left_matrix_y >> Right_matrix_x >> Right_matrix_y; // input matrix dimensions are taken
    ...
    //commented out the functions which helps to calculate time
    cout<<"GPU time = "<<et<<"ms"<<endl;

    cout<<"CPU time = "<<time_spent<<"ms"<<endl;
